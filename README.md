...
![tests](https://img.shields.io/badge/tests-618%20unit%20%2B%20438%20e2e-brightgreen)
...
> **한 줄 요약** — 단순 기능 구현을 넘어 **테스트 자동화(유닛 618 + E2E 438) · 데이터 정합성 검증 ·
...
- [테스트 전략](#테스트-전략)
- [테스트 자동화 상세 (E2E 438)](#테스트-자동화-상세-e2e-438)
...
- **테스트 자동화 1,056개** — Vitest 유닛 618 + Playwright **E2E 438**(기능 405 · 비기능 13 · **APK/WebView 20**). 스모크·모드·문항유형·네비·설정·영속성·엣지·반응형·접근성·**5모드 전이 25칸 전수**·**대용량 import**·**표/그림 문항**·**라이트박스/콘솔**·**저장 불가 환경**·**오프라인 출제**. 전체 시나리오: [`docs/e2e-test-scenarios.md`](docs/e2e-test-scenarios.md).
...
|---------|----------------------|------|
| 테스트 자동화 | Playwright **E2E 420개**(기능·비기능·APK) + Vitest **유닛 618개**(속성 기반 21 포함) 작성·CI 연동 | `e2e/`, `src/**/*.test.ts` |
...
```
        ▲  E2E (Playwright) — 420개: 사용자 플로우·엣지·크로스뷰포트·A11y(axe)·시드 랜덤 스모크·몽키·APK WebView
       ───
...
- 자동화 테스트: **유닛 618 + E2E 438 = 1,056** (E2E 내역: 기능 405 · 비기능 13 · APK/WebView 20. 전 문항 626 렌더 스윕 포함).
