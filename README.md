...
- **4지선다** — 지금 고른 세트에서 **보기가 4개인 문항만** 골라 섞어 냅니다(진위형·서답형·5지선다 제외 — 12세트에서 각각 15~50문항). 채점하면 시험과 같이 정답이 공개되고 **회차로 기록**되며, 틀린 문항은 오답 노트·오답 모드로 이어집니다. 표본이 시험과 달라 정답률을 나란히 비교하지는 마세요 — 통계의 성장폭 배지는 모드별로 갈라 계산합니다.
