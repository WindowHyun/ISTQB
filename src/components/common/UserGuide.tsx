    ...
    <div className="modal-body guide-body" data-testid="user-guide">
      ...
      <section className="guide-section">
        ...
        <ul>
          ...
          <li><strong>오답</strong> — 시험·랜덤·퀵에서 틀린 문항만 다시 풉니다(즉시 피드백).</li>
          <li><strong>⚡ 퀵 랜덤</strong> — 세트를 고르지 않고 <strong>해당 자격증의 전 세트</strong>에서 10·15·20문항을 뽑아 짧게 풉니다. 제한시간이 없고, 같은 문제가 여러 세트에 실려 있어도 한 세션에 두 번 나오지 않습니다. 입력이 오래 걸리는 서답형은 빼고 4지선다·진위형만 출제해요. 짧은 표본이라 <strong>합격 판정을 내리지 않고</strong> 맞힌 개수만 보여주며, <strong>응시 횟수·평균·최고 정답률에는 넣지 않습니다</strong>(챕터별 정답률에는 반영돼 약점 분석이 정확해집니다).</li>
        </ul>
      </section>
