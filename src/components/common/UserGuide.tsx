    ...
    <div className="modal-body guide-body" data-testid="user-guide">
      ...
      <section className="guide-section">
        ...
        <ul>
          ...
          <li><strong>미니 시험</strong> — <strong>통계</strong>에서 약한 챕터의 <strong>미니 시험</strong>을 누르면 그 챕터 문항 <strong>최대 10개</strong>를 뽑아 짧게 재측정합니다. 채점하면 챕터 정답률에 반영되지만, 세트 전체 회차가 아니라 <strong>응시 횟수·평균·최고 정답률에는 섞이지 않습니다</strong>(짧은 표본이 실전 지표를 부풀리지 않도록). 문제 위 배너에서 <strong>전체 보기</strong>를 누르면 챕터 제한이 풀려 그 세트에서 최대 40문항을 무작위로 뽑습니다. 실수로 <strong>새로고침해도 풀던 문항·답안이 그대로 유지</strong>됩니다.</li>
