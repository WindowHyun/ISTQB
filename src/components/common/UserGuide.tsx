    ...
    <div className="modal-body guide-body" data-testid="user-guide">
      ...
      <section className="guide-section">
        ...
        <ul>
          ...
          <li><strong>4지선다</strong> — 지금 고른 세트에서 <strong>보기가 4개인 문항만</strong> 골라 <em>섞어서</em> 냅니다(진위형·서답형·복수정답은 빠집니다). <strong>채점하기</strong>를 눌러야 정답이 공개되고 <strong>회차로 기록</strong>돼요. 시작 게이트·제한시간은 없습니다. 표본이 시험과 달라 <strong>합격 가늠(요약의 평균·최고 정답률)에는 넣지 않고</strong>, 회차는 <strong>세트별 회차 이력</strong>에 모드 이름과 함께 남습니다.</li>
