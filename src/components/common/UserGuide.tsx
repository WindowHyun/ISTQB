    ...
    <div className="modal-body guide-body" data-testid="user-guide">
      ...
      <section className="guide-section">
        ...
        <ul>
          ...
          <li><strong>⚡ 퀵 랜덤</strong> — 세트를 고르지 않고 <strong>해당 자격증의 전 세트</strong>를 섞어 한 문항씩 냅니다. <strong>문항 수를 고르지 않습니다</strong> — 끝을 정해 두지 않고 원하는 만큼 풀다가 그만두면 되고, 진행·정답·오답·연속은 문제 위 <strong>점수판</strong>에 상시 표시됩니다. 제한시간이 없고, 같은 문제가 여러 세트에 실려 있어도 한 세션에 두 번 나오지 않습니다. <strong>한 문항씩 채점합니다</strong> — 답을 고른 뒤 <strong>채점하기</strong>를 누르면 그 자리에서 정답·해설이 열리고, 같은 버튼이 <strong>다음 문제</strong>로 바뀝니다(고르는 것만으로는 정답이 보이지 않아요). 서답형이 있는 자격증에서는 섞여 나오되 <strong>어디서 끊어 봐도 30%를 넘지 않습니다</strong>. <strong>채점한 문항만</strong> 집계되고(아직 안 본 문항은 오답으로 세지 않아요), 짧은 표본이라 <strong>합격 판정을 내리지 않습니다</strong> — 세션을 마감하는 채점도, 결과 요약 화면도 없어요. <strong>회차 기록은 아예 남지 않습니다</strong> — 응시 이력·요약·타임라인 어디에도 뜨지 않아요(챕터별 정답률에는 반영돼 약점 분석이 정확해집니다). 틀린 문항은 오답 노트 맨 위 <strong>퀵 전용 임시 목록</strong>에 실리고 <strong>24시간 뒤 자동으로 사라집니다</strong>. 줄마다 <strong>오답 보기</strong>를 누르면 그 문항의 지문·보기·해설이 화면에 펼쳐집니다.</li>
        </ul>
      </section>
