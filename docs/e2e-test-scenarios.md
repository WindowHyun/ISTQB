...
> 아래는 초기 핵심 70개의 상세 G·W·T이며, 이후 엣지·확장 185개는 위 인덱스의 각 스펙 파일에 동일한 G·W·T 구조로 구현되어 있습니다.
...
- 로컬 검증: 설치된 chromium headless 기준 **255/255 통과**. CI는 자체 브라우저로 동일 실행.
