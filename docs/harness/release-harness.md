...
> 이 문서는 **전달 전 검증**을 다룹니다. 검증을 마친 뒤 실제로 내보내는 절차(버전·태그, Vercel/Firebase 배포, 실기기 스모크, 롤백)는 [`../release-playbook.md`](../release-playbook.md)에 있습니다.
...
npm run test:mutation:storage  # storage.ts·useQuizStore.ts를 고쳤다면 (break 65, 약 12분)
