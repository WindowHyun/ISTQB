...
| 워크플로 | 파일 | 트리거 | 하는 일 | 문서 |
| --- | --- | --- | --- | --- |
| **CI** | `.github/workflows/ci.yml` | push(main)·PR·수동 | 14 job 병렬 — 기능·품질: lint · verify-data · **pdf-data** · unit · **mutation** · build · android-build · **e2e** · **nonfunctional** · **apk** · **webkit**, 보안: **audit** · **secrets** · **codeql** | [`ci.md`](./ci.md) |
