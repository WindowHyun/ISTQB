...
| 워크플로 | 파일 | 트리거 | 하는 일 | 문서 |
| --- | --- | --- | --- | --- |
| **CI** | `.github/workflows/ci.yml` | push(main)·PR·수동 | 5 job 병렬: lint · verify-data · unit · build · **e2e** — 머지 품질 게이트 | [`ci.md`](./ci.md) |
...
- 권한 최소화: CI는 `contents: read`. Daily는 실패 이슈 작성을 위해 `issues: write` 추가.
